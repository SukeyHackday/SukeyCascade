...
public class SettingsActivity extends PreferenceActivity implements
	...
	public boolean onPreferenceClick(Preference preference) {
		if (preference == mSelectContacts) {
			...
			contacts[0] = new Contact("1234", "Test contact 1", 1, "+447810361502");
			contacts[1] = new Contact("7413", "Test contact 2", 2, "+447810361502");
			contacts[2] = new Contact("4789", "Test contact 3", 2, "+447810361502");
			contacts[3] = new Contact("9102", "Test contact 4", 5, "+447810361502");
